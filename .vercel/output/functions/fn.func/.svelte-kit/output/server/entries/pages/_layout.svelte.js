import { h as get_store_value, c as create_ssr_component, e as escape, d as add_attribute, i as compute_slots, f as setContext, j as compute_rest_props, g as getContext, k as spread, l as escape_attribute_value, o as escape_object, v as validate_component } from "../../chunks/ssr.js";
...
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M10 20v-6h4v6h5v-8h3L12 3L2 12h3v8h5Z"/>`}<!-- HTML_TAG_END --></svg>`;
});
const Logout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="m17 8l-1.4 1.4l1.6 1.6H9v2h8.2l-1.6 1.6L17 16l4-4l-4-4M5 5h7V3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h7v-2H5V5Z"/>`}<!-- HTML_TAG_END --></svg>`;
});
...
const Gamepad_square = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    [
      { viewBox: "0 0 24 24" },
      { width: "1.75em" },
...
const Target = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg${spread(
    ...
    {}
  )}><!-- HTML_TAG_START -->${`<path fill="currentColor" d="M11 2v2.07A8.002 8.002 0 0 0 4.07 11H2v2h2.07A8.002 8.002 0 0 0 11 19.93V22h2v-2.07A8.002 8.002 0 0 0 19.93 13H22v-2h-2.07A8.002 8.002 0 0 0 13 4.07V2m-2 4.08V8h2V6.09c2.5.41 4.5 2.41 4.92 4.91H16v2h1.91c-.41 2.5-2.41 4.5-4.91 4.92V16h-2v1.91C8.5 17.5 6.5 15.5 6.08 13H8v-2H6.09C6.5 8.5 8.5 6.5 11 6.08M12 11a1 1 0 0 0-1 1a1 1 0 0 0 1 1a1 1 0 0 0 1-1a1 1 0 0 0-1-1Z"/>`}<!-- HTML_TAG_END --></svg>`;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${validate_component(AppShell, "AppShell").$$render($$result, { slotPageHeader: "sticky top-0 z-10" }, {}, {
    pageFooter: () => {
      return `<p class="text-center" data-svelte-h="svelte-1uc9yj4">© 2023 Homegame Tracker. All rights reserved.</p>`;
    },
    sidebarLeft: () => {
      return `${validate_component(AppRail, "AppRail").$$render(
        $$result,
        {
        ...
        {
          trail: () => {
            return `${data.user ? `${validate_component(AppRailAnchor, "AppRailAnchor").$$render($$result, {}, {}, {
              lead: () => {
                return `${validate_component(Logout, "Logout").$$render($$result, {}, {}, {})} `;
              },
              default: () => {
                return `<form action="/logout" method="POST" data-svelte-h="svelte-1yrzkz5"><button type="submit" class="text-xl">Logout</button></form>`;
              }
            })}` : `${validate_component(AppRailAnchor, "AppRailAnchor").$$render($$result, { href: "/login" }, {}, {
              default: () => {
                return `<span class="text-xl" data-svelte-h="svelte-pq96bc">Login</span>`;
              }
            })}`} `;
          },
          lead: () => {
            return ` ${validate_component(AppRailAnchor, "AppRailAnchor").$$render($$result, { href: "/" }, {}, {
              lead: () => {
                return `${validate_component(Home, "IconHome").$$render($$result, {}, {}, {})} `;
              },
              default: () => {
                return `<span class="text-xl" data-svelte-h="svelte-1tw592g">Home</span>`;
              }
            })} ${data.user ? `${data.homegameData ? `${validate_component(AppRailAnchor, "AppRailAnchor").$$render($$result, { href: "/" + data.homegameData.name }, {}, {
              lead: () => {
                return `${validate_component(Gamepad_square, "Game").$$render($$result, {}, {}, {})} `;
              },
              default: () => {
                return `<span class="text-xl">${escape(data.homegameData.name)}</span>`;
              }
            })}` : `${validate_component(AppRailAnchor, "AppRailAnchor").$$render($$result, { href: "/create-homegame" }, {}, {
              default: () => {
    ...
    header: () => {
      return `${validate_component(AppBar, "AppBar").$$render($$result, { border: "border-b-2 border-slate-600" }, {}, {
        trail: () => {
          return `<a class="btn btn-md text-white text-xl font-bold hover:scale-125" rel="noreferrer" target="_blank" href="https://github.com">GitHub
        ${validate_component(Github, "GitHub").$$render($$result, {}, {}, {})}</a> `;
        },
        lead: () => {
          return `<a href="/" data-svelte-h="svelte-1ah9l0b"><strong class="text-2xl transition-all ease-in-out hover:scale-110 hover:bg-indigo-500 rounded p-4 hover:text-black duration-300 text-white uppercase mr-2 ">Homegame tracker</strong></a> ${validate_component(Target, "Target").$$render($$result, {}, {}, {})}`;
        }
      })} `;
    },
    default: () => {
